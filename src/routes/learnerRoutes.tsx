...
export const learnerRoutes = (queryClient: QueryClient): RouteObject[] => [
  ...
  { path: '/learner/course/:courseId', element: <SW><PR><LearnerCourseDetailPage /></PR></SW>, loader: async (args: any) => learnerLoaders.learnerCourseDetailLoader(queryClient, args) },
  { path: '/learner/course/:courseId/learn', element: <SW><PR><CoursePlayerPage /></PR></SW>, loader: async (args: any) => learnerLoaders.coursePlayerLoader(queryClient, args) },

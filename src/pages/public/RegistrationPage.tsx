                                    ...
                                    <FormControlLabel
                                        ...
                                        label={
                                            <Typography variant="body2" color="text.secondary">
                                                I agree to the <a href="/terms-of-service" target="_blank" rel="noopener noreferrer" style={{color: loginColors.primary[600], textDecoration: 'none'}}>Terms of Service</a> and <a href="/privacy-policy" target="_blank" rel="noopener noreferrer" style={{color: loginColors.primary[600], textDecoration: 'none'}}>Privacy Policy</a> *
                                            </Typography>
                                        }
                                    />

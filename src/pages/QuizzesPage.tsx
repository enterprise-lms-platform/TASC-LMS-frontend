...
const kpis = [
  { label: 'TOTAL QUIZZES', value: '18', icon: <QuizIcon />, gradient: 'linear-gradient(135deg, #3b82f6, #60a5fa)' },
  { label: 'COMPLETED', value: '12', icon: <PassIcon />, gradient: 'linear-gradient(135deg, #10b981, #34d399)' },
  { label: 'AVG. SCORE', value: '87%', icon: <ScoreIcon />, gradient: 'linear-gradient(135deg, #f59e0b, #fbbf24)' },
  { label: 'PENDING', value: '6', icon: <TimeIcon />, gradient: 'linear-gradient(135deg, #8b5cf6, #a78bfa)' },
];

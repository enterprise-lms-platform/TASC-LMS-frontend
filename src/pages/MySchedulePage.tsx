...
const kpis = [
  { label: 'THIS WEEK', value: '5', icon: <CalendarIcon />, gradient: 'linear-gradient(135deg, #3b82f6, #60a5fa)' },
  { label: 'UPCOMING', value: '12', icon: <UpcomingIcon />, gradient: 'linear-gradient(135deg, #f59e0b, #fbbf24)' },
  { label: 'COMPLETED', value: '28', icon: <CompletedIcon />, gradient: 'linear-gradient(135deg, #10b981, #34d399)' },
  { label: 'HOURS SCHEDULED', value: '18', icon: <TimeIcon />, gradient: 'linear-gradient(135deg, #8b5cf6, #a78bfa)' },
];

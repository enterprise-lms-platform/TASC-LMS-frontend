...
import { PhoneAndroid as MpesaIcon } from '@mui/icons-material';
      ...
      <Box component="main" sx={{ flexGrow: 1, width: { md: `calc(100% - ${DRAWER_WIDTH}px)` }, minWidth: 0 }}>
        ...
        <Box sx={{ p: { xs: 2, md: 3 }, maxWidth: 1400, mx: 'auto' }}>
          <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.5, mb: 3 }}>
            <Box sx={{ width: 40, height: 40, borderRadius: '12px', bgcolor: '#10b981', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              <MpesaIcon sx={{ color: 'white', fontSize: 22 }} />
            </Box>
            <Box>
              <Typography variant="h5" fontWeight={700}>M-Pesa</Typography>
              <Typography variant="body2" color="text.secondary">M-Pesa direct payment gateway</Typography>
            </Box>
          </Box>
          <Paper elevation={0} sx={{ p: 6, borderRadius: '1rem', textAlign: 'center', boxShadow: '0 1px 3px rgba(0,0,0,0.06)' }}>
            <Box sx={{ width: 72, height: 72, borderRadius: '50%', bgcolor: 'grey.100', display: 'flex', alignItems: 'center', justifyContent: 'center', mx: 'auto', mb: 2 }}>
              <MpesaIcon sx={{ fontSize: 36, color: 'grey.400' }} />
            </Box>
            <Typography variant="h6" fontWeight={600} mb={1}>Coming Soon</Typography>
            <Typography variant="body2" color="text.secondary" sx={{ maxWidth: 400, mx: 'auto' }}>
              M-Pesa direct integration is planned for a future release. All M-Pesa transactions are currently processed through PesaPal.
            </Typography>
          </Paper>
        </Box>
      </Box>

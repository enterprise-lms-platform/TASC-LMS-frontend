...
const FinanceProfilePage: React.FC = () => {
    ...
    <Box sx={{ display: 'flex', bgcolor: 'grey.100', minHeight: '100vh' }}>
      ...
      >
        <Toolbar sx={{ minHeight: '72px !important', gap: 2 }}>
          ...
          <Button startIcon={<BackIcon />} onClick={() => navigate('/finance')} sx={{ color: 'text.secondary', textTransform: 'none', fontWeight: 500 }}>
            Back
          </Button>
          <Box sx={{ flex: 1 }}>
          ...
          <Paper elevation={0} sx={cardSx}>
            <Box sx={{ p: 4, display: 'flex', alignItems: 'center', gap: 3, bgcolor: 'grey.50' }}>
              ...
              <Box>
                ...
                <Typography variant="body2" color="text.secondary">Finance</Typography>
              </Box>
            </Box>
          </Paper>

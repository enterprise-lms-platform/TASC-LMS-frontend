...
const kpis = [
  { label: 'UNREAD', value: '5', icon: <NotifIcon />, gradient: 'linear-gradient(135deg, #3b82f6, #60a5fa)' },
  { label: 'COURSE UPDATES', value: '12', icon: <CourseIcon />, gradient: 'linear-gradient(135deg, #10b981, #34d399)' },
  { label: 'ACHIEVEMENTS', value: '3', icon: <AwardIcon />, gradient: 'linear-gradient(135deg, #f59e0b, #fbbf24)' },
  { label: 'ANNOUNCEMENTS', value: '2', icon: <AnnouncementIcon />, gradient: 'linear-gradient(135deg, #8b5cf6, #a78bfa)' },
];
